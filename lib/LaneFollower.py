...
import threading
from lib.LaneFollower_threading import LaneFollower_threading as Lt
# try0000
...
class LandFollower:
    ...
    def find_line(
        ...
        #start threading
        leftthreading = threading.Thread(target=Lt.find_line_left_threading)
        leftthreading.start()
        rightthreading = threading.Thread(target=Lt.find_line_right_threading)
